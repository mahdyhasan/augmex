                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-8 text-sm-end">
                        <div class="head-icons">
                            <a href="{{ route('user.profile') }}" data-bs-toggle="tooltip" data-bs-placement="top"
                ...
                <div class="card-body pb-0 pt-2">
                    <ul class="nav nav-tabs nav-tabs-bottom">
                        <li class="nav-item me-3">
                            <a href="{{ route('user.profile') }}" class="nav-link px-0 active">
                        ...
                        <div class="card-body">
                            <div class="settings-sidebar">
                                ...
                                <div class="list-group list-group-flush settings-sidebar">
                                    <a href="{{ route('user.profile') }}" class="fw-medium active">Profile</a>
                                ...
                                <div class="mb-3">
                                    <div class="profile-upload">
                                        <div class="profile-upload-img">
                                            ...
                                            <img id="ImgPreview" src="{{ asset('public/assets/img/profiles/avatar-02.jpg') }}"
