                                ...
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="defaultLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="public/assets/img/theme/default.svg" alt="img">
                                        </span>                                     
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="miniLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="public/assets/img/theme/mini.svg" alt="img">
                                        </span>                                    
                         ...
                         <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="horizontal-singleLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="public/assets/img/theme/horizontal-single.svg" alt="img">
                                        </span>                                    
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="borderedCard">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="public/assets/img/theme/bordered.svg" alt="img">
                                        </span>                                     
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="borderlessCard">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="public/assets/img/theme/borderless.svg" alt="img">
                                        </span>                                    
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="shadowCard">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="public/assets/img/theme/shadow.svg" alt="img">
                                        </span>                                    
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="compactSize">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="public/assets/img/theme/compact.svg" alt="img">
                                        </span>                                    
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="hoverviewSize">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="public/assets/img/theme/hoverview.svg" alt="img">
                                        </span>                                    
                         ...
                         <div class="d-flex align-items-center">
                            <div class="theme-topbarbg me-3 mb-2">
                                ...
                                <label for="pattern1" class="d-block rounded">
                                    <img src="public/assets/img/theme/pattern-01.svg" alt="img" class="rounded">
                                </label>
                            </div>
                            <div class="theme-topbarbg me-3 mb-2">
                                <input type="radio" name="topbarbg" id="pattern2" value="pattern2">
                                <label for="pattern2" class="d-block rounded">
                                    <img src="public/assets/img/theme/pattern-02.svg" alt="img" class="rounded">
                                </label>
                            </div>
                            <div class="theme-topbarbg me-3 mb-2">
                                <input type="radio" name="topbarbg" id="pattern3" value="pattern3">
                                <label for="pattern3" class="d-block rounded">
                                    <img src="public/assets/img/theme/pattern-03.svg" alt="img" class="rounded">
                                </label>
                            </div>
                        </div>
